...
Nacos依赖数据库，一般与 MySQL 搭配使用。未安装 MySQL 请参考 [安装MySQL](docs/mysql/安装MySQL.md)

* 创建 Nacos 数据库 nacos_config

``` mysql
/*
 Navicat Premium Data Transfer

 Source Server         : 121.41.123.70(16核)
 Source Server Type    : MySQL
 Source Server Version : 80016
 Source Host           : 121.41.123.70:3306
...
--env MYSQL_SERVICE_PASSWORD=Xspace-nacos \
